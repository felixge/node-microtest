...
TestCase.prototype.recompileWithInjections = function(object, method) {
  var source = object[method].toString();
  var line = this._guessLine(source);
  ...
  for (var key in this.injected) {
    context[key] = this.injected[key];
  }

  var compiled = vm.runInNewContext(source, context, this._path);
  object[method] = compiled;
  return compiled;
};
...
TestCase.prototype.injects = function(globalVariable) {
  ...
  this._context[globalVariable] = value;
